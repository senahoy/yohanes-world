...
- Keyboard-only playable (WASD/arrows + E/Enter); touch joystick + labeled JUMP/ACT buttons on mobile (always landscape — portrait auto-rotates the view and stays playable, with a brief rotate hint).
